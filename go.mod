...
require (
	...
	github.com/tektoncd/results/tools/tkn-results v0.0.0-20230907073809-19101624f537
)
...
require (
	...
	github.com/ktrysmt/go-bitbucket v0.9.65 // indirect
...
replace (
	...
	knative.dev/pkg => knative.dev/pkg v0.0.0-20230502134655-db8a35330281
)
